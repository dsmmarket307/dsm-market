...
export default async function AdminDashboard() {
  ...
  const menuItems = [
    ...
    { href: "/dashboard/admin/ai-business", label: "Centro IA", desc: "Estrategias, metas y proyecciones con IA", color: "#a78bfa", badge: 0, icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#a78bfa" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>, green: false },
