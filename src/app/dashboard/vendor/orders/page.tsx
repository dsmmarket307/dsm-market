...
export default async function VendorOrdersPage() {
  ...
  const css = `
    ...
    *{box-sizing:border-box;}
    ...
    .var-tag{display:inline-block;background:#1a1500;border:1px solid rgba(212,175,55,.25);color:#D4AF37;font-size:11px;font-weight:600;padding:3px 10px;border-radius:6px;margin-right:6px;margin-top:4px;}
  `
