    ...
    <div style={{ minHeight: '100vh', background: '#fff', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #0a0a0a 0%, #1c1c1c 100%)', padding: 'clamp(3rem, 8vw, 6rem) clamp(1rem, 4vw, 2rem)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ color: '#fff', fontSize: 'clamp(1.75rem, 5vw, 3.25rem)', fontWeight: 700, marginBottom: '1rem', lineHeight: 1.2 }}>Encuentra el experto<br />que necesitas</h1>
          <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 'clamp(0.875rem, 2vw, 1.05rem)', maxWidth: '480px', margin: '0 auto 2rem', lineHeight: 1.7 }}>Conectamos clientes con profesionales en toda Colombia.</p>
          <a href="/auth/register-provider" style={{ display: 'inline-block', background: '#C9A84C', color: '#fff', padding: '0.9rem 2.25rem', textDecoration: 'none', fontSize: '0.85rem', fontWeight: 700, letterSpacing: '1px', borderRadius: '999px', boxShadow: '0 4px 20px rgba(201,168,76,0.4)' }}>Publica tu servicio gratis</a>
              ...
              <div key={service.id}
                ...
                <div style={{ padding: '1.25rem' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
                    <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'linear-gradient(135deg, #C9A84C, #e8c96d)', overflow: 'hidden', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', border: '3px solid #fff', boxShadow: '0 2px 8px rgba(0,0,0,0.15)' }}>
                      {service.avatar_url ? (
      ...
      <div style={{ background: 'linear-gradient(135deg, #0a0a0a, #1c1c1c)', padding: 'clamp(3rem, 5vw, 4rem) clamp(1rem, 4vw, 2rem)', textAlign: 'center', marginTop: '3rem' }}>
        ...
        <a href="/auth/register-provider" style={{ display: 'inline-block', background: '#C9A84C', color: '#fff', padding: '0.9rem 2.25rem', textDecoration: 'none', fontSize: '0.85rem', fontWeight: 700, borderRadius: '999px' }}>Publicar mi servicio gratis</a>
      </div>
