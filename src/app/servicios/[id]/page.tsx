...
export default async function ServiceDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <main style={{ background: "#0B0B0B", minHeight: "100vh", color: "#fff", padding: "2rem", fontFamily: "sans-serif" }}>
      ...
      <a href={waUrl} target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", marginTop: "1rem", background: "#25D366", color: "#fff", padding: "0.75rem 1.5rem", borderRadius: "8px", textDecoration: "none", fontWeight: 700 }}>Contactar por WhatsApp</a>
    </main>
  )
}